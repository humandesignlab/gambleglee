...
class TestBettingAPI:
    ...
    @pytest.mark.asyncio
    async def test_create_bet_insufficient_funds(self, async_test_client, test_user_token):
    ...
    @pytest.mark.asyncio
    async def test_accept_bet_success(self, async_test_client, test_bet, test_user_2_token):
    ...
    @pytest.mark.asyncio
    async def test_accept_bet_insufficient_funds(self, async_test_client, test_bet, test_user_2_token):
        """Test accepting bet with insufficient funds"""
        # Mock insufficient funds scenario
        with patch('app.services.betting_service.BettingService._check_betting_limits') as mock_check:
    ...
    @pytest.mark.asyncio
    async def test_resolve_bet_success(self, async_test_client, test_bet, test_user_token):
    ...
    @pytest.mark.asyncio
    async def test_resolve_bet_wrong_status(self, async_test_client, test_bet, test_user_token):
    ...
    @pytest.mark.asyncio
    async def test_cancel_bet_success(self, async_test_client, test_bet, test_user_token):
    ...
    @pytest.mark.asyncio
    async def test_cancel_bet_wrong_user(self, async_test_client, test_bet, test_user_2_token):
    ...
    @pytest.mark.asyncio
    async def test_get_user_bets_with_status_filter(self, async_test_client, test_user_token):
    ...
    @pytest.mark.asyncio
    async def test_concurrent_bet_operations(self, async_test_client, test_bet, test_user_2_token):
    ...
    @pytest.mark.asyncio
    async def test_bet_workflow_complete(self, async_test_client, test_user_token, test_user_2_token):
    ...
    @pytest.mark.asyncio
    async def test_error_handling_business_logic(self, async_test_client, test_bet, test_user_token):
