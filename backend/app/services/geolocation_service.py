...
class GeolocationService:
    ...
    def get_payment_processor(self, location_data: Dict[str, Any]) -> str:
        ...
        if country == "US":
            ...
            return "mercadopago"
        elif country in ["CA", "GB", "AU", "DE", "FR", "ES", "IT", "NL"]:
            return "stripe"  # Stripe supports these countries
        else:
            return "crypto"  # Fallback to cryptocurrency
    ...
    def get_payment_methods(self, location_data: Dict[str, Any]) -> list:
        ...
        if country == "US":
            ...
            return ["card", "sepa", "bank_transfer"]
        else:
            return ["crypto", "paypal"]
