          ...
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="text-red-700 mt-1">
                GambleGlee is not available in your location (
                {location?.country_name}). We're working to expand to more
                regions soon.
              </p>
            </div>
          </div>
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
          <div className="flex items-center">
            ...
            <span className="text-sm text-blue-800">
              Detected location: {location.country_name} • Payment processor:{" "}
              {location.payment_processor} • Currency: {getCurrencySymbol()}
              {location.currency}
            </span>
          </div>
        </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">
                  Maximum: {getCurrencySymbol()}
                  {compliance?.deposit_limits?.daily || 10000} daily
                </p>
              </div>
          ...
          <div className="bg-white rounded-lg p-6 w-full max-w-md">
            ...
            <div className="space-y-4">
              <div>
                ...
                />
                <p className="text-xs text-gray-500 mt-1">
                  Available: ${wallet?.balance?.toFixed(2) || "0.00"} | Maximum:
                  $5,000
                </p>
              </div>
              ...
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3">
                <p className="text-sm text-yellow-800">
                  <strong>Note:</strong> Withdrawals are processed manually and
